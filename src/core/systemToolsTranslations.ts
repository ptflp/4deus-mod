...
Record<string, ControllerOptionsTranslation> = {
  arabic: {
    ...
    trackpadAutoRecoveryDescription: "يستعيد تلقائيًا لوحات التتبع المتجمدة أو العالقة. معطّل افتراضيًا",
  },
  brazilian: {
    controller: "Controle",
    trackpadAutoRecovery: "Recuperação automática do trackpad",
    trackpadAutoRecoveryDescription: "Recupera automaticamente trackpads travados ou sem resposta. Desativado por padrão",
  },
  bulgarian: {
    controller: "Контролер",
    trackpadAutoRecovery: "Автоматично възстановяване на тракпада",
    trackpadAutoRecoveryDescription: "Автоматично възстановява блокирали или заседнали тракпади. Изключено по подразбиране",
  },
  czech: {
    controller: "Ovladač",
    trackpadAutoRecovery: "Automatické obnovení trackpadu",
    trackpadAutoRecoveryDescription: "Automaticky obnoví zamrzlé nebo zaseknuté trackpady. Ve výchozím nastavení vypnuto",
  },
  danish: {
    controller: "Controller",
    trackpadAutoRecovery: "Automatisk gendannelse af pegefelt",
    trackpadAutoRecoveryDescription: "Gendanner automatisk frosne eller fastlåste pegefelter. Deaktiveret som standard",
  },
  dutch: {
    controller: "Controller",
    trackpadAutoRecovery: "Automatisch trackpadherstel",
    trackpadAutoRecoveryDescription: "Herstelt automatisch vastgelopen of geblokkeerde trackpads. Standaard uitgeschakeld",
  },
  finnish: {
    controller: "Ohjain",
    trackpadAutoRecovery: "Ohjauslevyn automaattinen palautus",
    trackpadAutoRecoveryDescription: "Palauttaa jumiutuneet tai lukkiutuneet ohjauslevyt automaattisesti. Oletuksena pois käytöstä",
  },
  french: {
    controller: "Manette",
    trackpadAutoRecovery: "Récupération automatique du pavé tactile",
    trackpadAutoRecoveryDescription: "Récupère automatiquement les pavés tactiles figés ou bloqués. Désactivé par défaut",
  },
  german: {
    controller: "Controller",
    trackpadAutoRecovery: "Automatische Trackpad-Wiederherstellung",
    trackpadAutoRecoveryDescription: "Stellt eingefrorene oder festhängende Trackpads automatisch wieder her. Standardmäßig deaktiviert",
  },
  greek: {
    controller: "Χειριστήριο",
    trackpadAutoRecovery: "Αυτόματη επαναφορά trackpad",
    trackpadAutoRecoveryDescription: "Επαναφέρει αυτόματα παγωμένα ή κολλημένα trackpad. Απενεργοποιημένο από προεπιλογή",
  },
  hungarian: {
    controller: "Vezérlő",
    trackpadAutoRecovery: "Érintőpad automatikus helyreállítása",
    trackpadAutoRecoveryDescription: "Automatikusan helyreállítja a lefagyott vagy beragadt érintőpadokat. Alapértelmezés szerint kikapcsolva",
  },
  indonesian: {
    controller: "Kontroler",
    trackpadAutoRecovery: "Pemulihan trackpad otomatis",
    trackpadAutoRecoveryDescription: "Memulihkan trackpad yang macet atau tidak merespons secara otomatis. Dinonaktifkan secara default",
  },
  italian: {
    controller: "Controller",
    trackpadAutoRecovery: "Ripristino automatico del trackpad",
    trackpadAutoRecoveryDescription: "Ripristina automaticamente i trackpad bloccati o che non rispondono. Disattivato per impostazione predefinita",
  },
  japanese: {
    controller: "コントローラー",
    trackpadAutoRecovery: "トラックパッドの自動復旧",
    trackpadAutoRecoveryDescription: "フリーズまたは固着したトラックパッドを自動的に復旧します。初期設定では無効です",
  },
  koreana: {
    controller: "컨트롤러",
    trackpadAutoRecovery: "트랙패드 자동 복구",
    trackpadAutoRecoveryDescription: "멈추거나 고정된 트랙패드를 자동으로 복구합니다. 기본적으로 비활성화되어 있습니다",
  },
  latam: {
    controller: "Control",
    trackpadAutoRecovery: "Recuperación automática del trackpad",
    trackpadAutoRecoveryDescription: "Recupera automáticamente los trackpads congelados o atascados. Desactivado de forma predeterminada",
  },
  malay: {
    controller: "Pengawal",
    trackpadAutoRecovery: "Pemulihan pad jejak automatik",
    trackpadAutoRecoveryDescription: "Memulihkan pad jejak yang beku atau tersekat secara automatik. Dilumpuhkan secara lalai",
  },
  norwegian: {
    controller: "Kontroller",
    trackpadAutoRecovery: "Automatisk gjenoppretting av styreflate",
    trackpadAutoRecoveryDescription: "Gjenoppretter automatisk styreflater som har frosset eller satt seg fast. Deaktivert som standard",
  },
  polish: {
    controller: "Kontroler",
    trackpadAutoRecovery: "Automatyczne odzyskiwanie gładzika",
    trackpadAutoRecoveryDescription: "Automatycznie przywraca zawieszone lub zablokowane gładziki. Domyślnie wyłączone",
  },
  portuguese: {
    controller: "Comando",
    trackpadAutoRecovery: "Recuperação automática do trackpad",
    trackpadAutoRecoveryDescription: "Recupera automaticamente trackpads bloqueados ou sem resposta. Desativado por predefinição",
  },
  romanian: {
    controller: "Controler",
    trackpadAutoRecovery: "Recuperarea automată a trackpadului",
    trackpadAutoRecoveryDescription: "Recuperează automat trackpadurile înghețate sau blocate. Dezactivat implicit",
  },
  russian: {
    controller: "Контроллер",
    trackpadAutoRecovery: "Автовосстановление трекпадов",
    trackpadAutoRecoveryDescription: "Автоматически восстанавливает зависшие или залипшие трекпады. По умолчанию выключено",
  },
  schinese: {
    controller: "控制器",
    trackpadAutoRecovery: "触控板自动恢复",
    trackpadAutoRecoveryDescription: "自动恢复冻结或卡住的触控板。默认关闭",
  },
  spanish: {
    controller: "Mando",
    trackpadAutoRecovery: "Recuperación automática del trackpad",
  ...
  swedish: {
    ...
    trackpadAutoRecoveryDescription: "Återställer automatiskt styrplattor som har frusit eller fastnat. Inaktiverat som standard",
  },
  tchinese: {
    controller: "控制器",
    trackpadAutoRecovery: "觸控板自動復原",
    trackpadAutoRecoveryDescription: "自動復原凍結或卡住的觸控板。預設關閉",
  },
  thai: {
    controller: "คอนโทรลเลอร์",
    trackpadAutoRecovery: "การกู้คืนแทร็กแพดอัตโนมัติ",
    trackpadAutoRecoveryDescription: "กู้คืนแทร็กแพดที่ค้างหรือติดโดยอัตโนมัติ ปิดใช้งานโดยค่าเริ่มต้น",
  },
  turkish: {
    controller: "Denetleyici",
    trackpadAutoRecovery: "Otomatik izleme dörtgeni kurtarma",
    trackpadAutoRecoveryDescription: "Donmuş veya takılı kalan izleme dörtgenlerini otomatik olarak kurtarır. Varsayılan olarak kapalıdır",
  },
  ukrainian: {
    controller: "Контролер",
    trackpadAutoRecovery: "Автовідновлення трекпадів",
    trackpadAutoRecoveryDescription: "Автоматично відновлює завислі або залиплі трекпади. Типово вимкнено",
  },
  vietnamese: {
    controller: "Tay cầm",
    trackpadAutoRecovery: "Tự động khôi phục bàn di chuột",
    trackpadAutoRecoveryDescription: "Tự động khôi phục bàn di chuột bị treo hoặc kẹt. Tắt theo mặc định",
  },
};
