...
export const SYSTEM_TOOLS_SETTINGS_ROUTE = "/4deus-mod/system-tools";
...
export const ModsPanel = ({ settings }: ModsPanelProps) => {
  ...
  return (
    <PanelSection title="4deus Mod">
      ...
      <Field
        label={strings.systemTools}
        description={strings.systemToolsDescription}
        icon={<FaTools />}
        childrenLayout="inline"
        childrenContainerWidth="max"
        inlineWrap="keep-inline"
      ...
      >
        <DialogButton
          aria-label={strings.systemTools}
          onClick={() => openSettings(SYSTEM_TOOLS_SETTINGS_ROUTE)}
          style={{
            alignItems: "center",
            display: "flex",
            justifyContent: "center",
